                ...
                <div className='flex flex-col'>
                    <div className='flex flex-row gap-x-6'>
                        ...
                        <div className='basis-2/5 flex flex-col  items-start'>
                            ...
                            <div className='pt-7 '><input type='date' className='p-2 w-72 border border-gray-500 rounded-md' value={moment(dob).format('YYYY-MM-DD')} onChange={e => setDoB(moment(e.target.value).format('YYYY-MM-DD'))}/></div>
